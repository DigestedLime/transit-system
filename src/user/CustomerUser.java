...
/**
 * A Customer User is a customer that uses the transit system. They have an
 * email, a list of the recent trips, and a list of TravelCards that they own
 *
 */
public class CustomerUser extends User {
	 ...
	 * @param password
	 * @param email
	 * @return true iff the password and email inputted match the email and password
	 *         of this customer
	 */
	...
	/**
	 * Adds a trip to the list of trips, assuming it is already a string
	 * representation
	 * 
	 * @param trip
	 */
	...
	/**
	 * Adds a card that is owned by the customer. Only used when reading from
	 * customer_users.txt for existing users
	 * 
	 * @param id
	 * @param balance
	 * @param suspended
