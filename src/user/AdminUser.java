...
/**
 * AdminUser that is used to identify if a user can have access to an admin panel
 */
class AdminUser extends User {
	...
	/**
	 * To have more admins, only an admin can make more, as we want it so not everyone can make an
	 * admin
	 * 
